...
function combate(gladiador1, gladiador2, message) {
    var logCombateText = "";
    var critico = gladiador1.nombre == adminActual.nombre ? Math.floor(Math.random() * 6) + 1 : Math.floor(Math.random() * 7) + 1;
    var esquive = gladiador1.nombre == adminActual.nombre ? Math.floor(Math.random() * 6) + 1 : Math.floor(Math.random() * 7) + 1;
