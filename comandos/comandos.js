    ...
    execute(message, args, cmd, client, Discord, profileData) {
        ...
        const newEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: 'udyr equipo @amigo1 @amigo2', value: 'Te hace un equipo contigo y tus amigos que menciones' },
                ...
                { name: 'udyr efectos/memes', value: 'Listado con los efectos y memes que monta udyr' },
                ...
                { name: 'udyr stop/skip/pause/unpause/resume', value: 'Controles para la musica (solo funciona en <#888550185616166922>)' },
